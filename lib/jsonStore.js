...
<<<<<<< HEAD
const config = require('../conf/default.config.js');
=======
...
<<<<<<< HEAD
  const pureName = fileName.getHeadUpperName(info.pageName);
  request
...
=======
  ...
  request
    ...
    .end((err, res) => {
      if (err) {
        console.log('[log][JsonStore]: CreateErr: ', err);
      } else {
        console.log('[log][JsonStore]: Create Sucess');
      }
    })
>>>>>>> upstream/master
}
